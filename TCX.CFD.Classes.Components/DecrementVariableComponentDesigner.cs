...
[ActivityDesignerTheme(typeof(DecrementVariableComponentTheme))]
public class DecrementVariableComponentDesigner : ComponentDesigner
{
	...
	protected override ActivityDesignerVerbCollection Verbs
	{
		get
		{
			if (verbs == null)
			{
				...
				ActivityDesignerVerb activityDesignerVerb = new ActivityDesignerVerb(this, DesignerVerbGroup.General, LocalizedResourceMgr.GetString("ComponentDesigners.DecrementVariable.ConfigureVerb"), OnConfigure);
	...
	{
		if (!(base.Activity is DecrementVariableComponent decrementVariableComponent))
		{
			return;
		}
		IncrementDecrementVariableConfigurationForm ıncrementDecrementVariableConfigurationForm = new IncrementDecrementVariableConfigurationForm(decrementVariableComponent);
	...
	{
		ComponentDesignerHelper.UpdateExistingProperty(properties, "Name", "Decrement Variable", "Please specify the name of the component. It has to be unique in the entire flow.");
