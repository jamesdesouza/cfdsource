...
public class TcxExtensionValidatorConfigurationForm : Form
{
	...
	public TcxExtensionValidatorConfigurationForm(TcxExtensionValidatorComponent tcxExtensionValidatorComponent)
	{
		InitializeComponent();
		this.tcxExtensionValidatorComponent = tcxExtensionValidatorComponent;
		validVariables = ExpressionHelper.GetValidVariables(tcxExtensionValidatorComponent);
		txtExtension.Text = tcxExtensionValidatorComponent.Extension;
		TxtExtension_Validating(txtExtension, new CancelEventArgs());
		Text = LocalizedResourceMgr.GetString("TcxExtensionValidatorConfigurationForm.Title");
		lblExtension.Text = LocalizedResourceMgr.GetString("TcxExtensionValidatorConfigurationForm.lblExtension.Text");
		okButton.Text = LocalizedResourceMgr.GetString("TcxExtensionValidatorConfigurationForm.okButton.Text");
		cancelButton.Text = LocalizedResourceMgr.GetString("TcxExtensionValidatorConfigurationForm.cancelButton.Text");
	}
	...
	private void TxtExtension_Validating(object sender, CancelEventArgs e)
	{
		...
		{
			errorProvider.SetError(editExtensionButton, LocalizedResourceMgr.GetString("TcxExtensionValidatorConfigurationForm.Error.ExtensionIsMandatory"));
			return;
		}
		AbsArgument absArgument = AbsArgument.BuildArgument(validVariables, txtExtension.Text);
		errorProvider.SetError(editExtensionButton, absArgument.IsSafeExpression() ? string.Empty : LocalizedResourceMgr.GetString("TcxExtensionValidatorConfigurationForm.Error.ExtensionIsInvalid"));
	}

	private void EditExtensionButton_Click(object sender, EventArgs e)
	{
		ExpressionEditorForm expressionEditorForm = new ExpressionEditorForm(tcxExtensionValidatorComponent);
	...
	private void TcxExtensionValidatorConfigurationForm_HelpButtonClicked(object sender, CancelEventArgs e)
	{
		tcxExtensionValidatorComponent.ShowHelp();
	}

	private void TcxExtensionValidatorConfigurationForm_HelpRequested(object sender, HelpEventArgs hlpevent)
	{
		tcxExtensionValidatorComponent.ShowHelp();
	}
	...
	private void InitializeComponent()
	{
		...
		base.Name = "TcxExtensionValidatorConfigurationForm";
		base.ShowIcon = false;
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "Extension Validator";
		base.HelpButtonClicked += new System.ComponentModel.CancelEventHandler(TcxExtensionValidatorConfigurationForm_HelpButtonClicked);
		base.HelpRequested += new System.Windows.Forms.HelpEventHandler(TcxExtensionValidatorConfigurationForm_HelpRequested);
