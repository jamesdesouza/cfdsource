...
public class ToStringFunction : AbsFunction
{
	...
	public ToStringFunction(List<string> validVariables, string name, List<string> arguments)
	...
	{
		return LocalizedResourceMgr.GetString("ExpressionEditorForm.ToStringFunction.ExpressionHelpText");
	}

	public override object Evaluate(IList variableValues)
	{
		return Convert.ToString(base.ArgumentList[0].Evaluate(variableValues));
	}
}
