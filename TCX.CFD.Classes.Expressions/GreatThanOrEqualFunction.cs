...
public class GreatThanOrEqualFunction : AbsFunction
{
	...
	public GreatThanOrEqualFunction(List<string> validVariables, string name, List<string> arguments)
	...
	{
		return LocalizedResourceMgr.GetString("ExpressionEditorForm.GreatThanOrEqualFunction.ExpressionHelpText");
	}
