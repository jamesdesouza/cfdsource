...
public class GreatThanFunction : AbsFunction
{
	...
	public GreatThanFunction(List<string> validVariables, string name, List<string> arguments)
	...
	{
		return LocalizedResourceMgr.GetString("ExpressionEditorForm.GreatThanFunction.ExpressionHelpText");
	}
