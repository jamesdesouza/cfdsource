...
public class EqualFunction : AbsFunction
{
	...
	public EqualFunction(List<string> validVariables, string name, List<string> arguments)
	...
	{
		return LocalizedResourceMgr.GetString("ExpressionEditorForm.EqualFunction.ExpressionHelpText");
	}
